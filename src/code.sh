...
if [ $skip == false ];
	then
		...
		#-0v uncompressed vcf
		#-o output name
  		docker run -v /home/dnanexus:/home/dnanexus --rm ${Docker_image_name} convert --gvcf2vcf -R $BEDfile_path -f /home/dnanexus/genome.fa -Ov -o ~/out/PRS_output/PRS_output/${vcf_name}.vcf $vcf_path
		# capture samplename
		samplename=$vcf_name
